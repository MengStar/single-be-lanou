...
import { SET_AUTH, CHANGE_FORM, SENDING_REQUEST, SET_ERROR_MESSAGE } from '../utils/constants/LoginConstants';
import * as errorMessages  from '../utils/constants/MessageConstants';
...
export function login(username, password) {
  return (dispatch) => {
    ...
    bcrypt.hash(password, salt, (err, hash) => {
      ...
      // Use auth.js to fake a request，第三个参数传入了一个匿名的callback
